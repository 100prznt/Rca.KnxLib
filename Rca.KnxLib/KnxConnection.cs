...
namespace KNXLib
{
    ...
    public abstract class KnxConnection
    {
        ...
        {
            m_LockManager.UnlockConnection();
            ...
            Logger.Debug(ClassName, "KNX is connected. Unlocking send - {0} free locks", m_LockManager.LockCount);
        }
        ...
        internal virtual void Disconnected()
        {
            ...
            Logger.Debug(ClassName, "Send locked - {0} free locks", m_LockManager.LockCount);
        }
        ...
        {
            m_LockManager.IntervalMs = interval;
        }
        ...
        public void Action(string address, byte[] data)
        {
            ...
            m_LockManager.PerformLockedOperation(() => KnxSender.Action(address, data));
        ...
        public void RequestStatus(string address)
        {
            ...
            m_LockManager.PerformLockedOperation(() => KnxSender.RequestStatus(address));
